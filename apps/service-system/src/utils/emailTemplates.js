export const createVerificationEmailTemplate = (username, verificationCode) => {
    return {
...
export const createEmailChangeVerificationTemplate = (username, verificationCode, newEmail) => {
    return {
